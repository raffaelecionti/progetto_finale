...
<img src="{{  $article->images->isNotEmpty() ? $article->images->first()->getUrl(3oo, 300)   : 'https://picsum.photos/200'}}" class="card-img-top" alt="immagine dell'articolo {{ $article->title }}">
 <div class="card-body">
